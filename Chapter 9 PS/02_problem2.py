...
This program simulates a simple game where:

A random score is generated.

The score is compared to the "Hi-score" (highest score saved in a file called hiscore.txt).

If the new score is greater than the existing Hi-score, it updates the file with the new Hi-score.
'''
